...
RcppExport SEXP _SoftBartFork_rmvnorm(SEXP meanSEXP, SEXP PrecisionSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _SoftBartFork_choll(SEXP SigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SoftBartFork_update_sigma(SEXP rSEXP, SEXP sigma_hatSEXP, SEXP sigma_oldSEXP, SEXP temperatureSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SoftBartFork_rlgam(SEXP shapeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SoftBartFork_do_mh(SEXP loglik_newSEXP, SEXP loglik_oldSEXP, SEXP new_to_oldSEXP, SEXP old_to_newSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_SoftBartFork_rmvnorm", (DL_FUNC) &_SoftBartFork_rmvnorm, 2},
    {"_SoftBartFork_choll", (DL_FUNC) &_SoftBartFork_choll, 1},
    {"_SoftBartFork_update_sigma", (DL_FUNC) &_SoftBartFork_update_sigma, 4},
    {"_SoftBartFork_rlgam", (DL_FUNC) &_SoftBartFork_rlgam, 1},
    {"_SoftBartFork_SoftBart", (DL_FUNC) &_SoftBartFork_SoftBart, 33},
    {"_SoftBartFork_do_mh", (DL_FUNC) &_SoftBartFork_do_mh, 4},
    {"_rcpp_module_boot_mod_forest", (DL_FUNC) &_rcpp_module_boot_mod_forest, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_SoftBartFork(DllInfo *dll) {
